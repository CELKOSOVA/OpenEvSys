<div class="panel">
    <div class="form-container">
      <form class="form-horizontal"  action='<?php echo get_url($_GET['mod'],'subformat_edit', null, array('subformat' => $subformat_name, 'subid' => $subid))?>' name="subformat_form" method='post' enctype='multipart/form-data'>
